/**
 * address controller - JavaScript implementation
...
module.exports = factories.createCoreController('api::address.address', ({ strapi }) => ({
  /**
    ...
    try {
      ...
      const params = {
        ...
        pagination: {
          ...
          pageSize: Math.min(parseInt(pageSize, 10), 50) // Max 50 addresses
        }
      };
  ...
  async create(ctx) {
    try {
      ...
      const addressData = ctx.request.body.data || ctx.request.body;
