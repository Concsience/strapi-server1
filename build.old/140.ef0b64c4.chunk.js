...
`,fs=({onClick:e,className:t,hasConditions:o=!1,variant:n="tertiary"})=>{const{formatMessage:r}=(0,k.A)();return(0,s.jsx)(xs,{hasConditions:o,className:t,children:(0,s.jsx)(B.$,{variant:n,startIcon:(0,s.jsx)(Ze.A,{}),onClick:e,children:r({id:"global.settings",defaultMessage:"Settings"})})})},xs=(0,S.Ay)(j.a)`
