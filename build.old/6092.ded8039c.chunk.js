"use strict";(globalThis.webpackChunkstrapi_server_2=globalThis.webpackChunkstrapi_server_2||[]).push([[6092],{16092:(H,T,t)=>{t.d(T,{ProtectedListPage:()=>gt});var s=t(92132),g=t(21272),x=t(11273),M=t(42455),b=t(38413),C=t(55356),W=t(74773),c=t(30893),i=t(85963),o=t(4198),h=t(94061),d=t(35513),f=t(40216),B=t(26127),D=t(90361),l=t(33363),L=t(50215),O=t(98765),k=t(25641),I=t(83997),J=t(63891);const R=J.Ay.div`
...
`,c=(0,g.Ay)(x.a)`
  ...
  width: 100%;
  border: none;
`,i=({children:o,icon:h,...d})=>(0,s.jsxs)("div",{children:[(0,s.jsx)(M.c,{}),(0,s.jsx)(c,{as:"button",background:"primary100",padding:5,...d,children:(0,s.jsxs)(b.s,{children:[(0,s.jsx)(W,{"aria-hidden":!0,background:"primary200",children:h}),(0,s.jsx)(x.a,{paddingLeft:3,children:(0,s.jsx)(C.o,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:o})})]})})]})},81109:(H,T,t)=>{t.d(T,{u:()=>c});var s=t(28190);const g=s.n.injectEndpoints({endpoints:i=>({getWebhooks:i.query({query:o=>({url:`/admin/webhooks/${o?.id??""}`,method:"GET"}),transformResponse:o=>Array.isArray(o.data)?o.data:[o.data],providesTags:(o,h,d)=>typeof d=="object"&&"id"in d?[{type:"Webhook",id:d.id}]:[...o?.map(({id:f})=>({type:"Webhook",id:f}))??[],{type:"Webhook",id:"LIST"}]}),createWebhook:i.mutation({query:o=>({url:"/admin/webhooks",method:"POST",data:o}),transformResponse:o=>o.data,invalidatesTags:[{type:"Webhook",id:"LIST"}]}),updateWebhook:i.mutation({query:({id:o,...h})=>({url:`/admin/webhooks/${o}`,method:"PUT",data:h}),transformResponse:o=>o.data,invalidatesTags:(o,h,{id:d})=>[{type:"Webhook",id:d}]}),triggerWebhook:i.mutation({query:o=>({url:`/admin/webhooks/${o}/trigger`,method:"POST"}),transformResponse:o=>o.data}),deleteManyWebhooks:i.mutation({query:o=>({url:"/admin/webhooks/batch-delete",method:"POST",data:o}),transformResponse:o=>o.data,invalidatesTags:(o,h,{ids:d})=>d.map(f=>({type:"Webhook",id:f}))})}),overrideExisting:!1}),{useGetWebhooksQuery:x,useCreateWebhookMutation:M,useUpdateWebhookMutation:b,useTriggerWebhookMutation:C,useDeleteManyWebhooksMutation:W}=g,c=(i=void 0,o)=>{const{data:h,isLoading:d,error:f}=x(i,o),[B,{error:D}]=M(),[l,{error:L}]=b(),[O]=C(),[k]=W();return{webhooks:h,isLoading:d,error:f||D||L,createWebhook:B,updateWebhook:l,triggerWebhook:O,deleteManyWebhooks:k}}}}]);
